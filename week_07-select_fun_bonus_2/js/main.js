// DONE 1.	When the header element is clicked
...
// 2. When the "Throw a party" button is clicked
  // DONE a. Remove the boring class from the section with the id boxes
  // DONE b. Fade out all of the divs in #row4 slowly (hint: your selector could be $('#row4 div') )
  //DONE c. Add a class snazzy in your css and add it to all items with the class .box
  // DONE c. Change the styling of the span inside of #box3 by adding a class fun (and style that fun class in CSS)
  //DONE SlideUp all the h2s on the page quickly
  // DONE Add the selected class [already in the CSS] to the divs in #row3
...
// 3. When the anchor in #box2 is clicked (hint: your selector could be $('#box2 a') )
  //DONE a. Fade in the footer slowly
